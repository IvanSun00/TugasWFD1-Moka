...
@section('content')
    ...
    <div class=" pt-10 pb-20 px-5 bg-primary-whiteGray">
        <div class="grid grid-cols-2 gap-4 mx-0 md:mx-auto md:w-[65vw] w-full ">
            <div class="item1">
                <h1 class="text-xl lg:text-2xl font-bold mb-10 text-center">Pertanyaan Tentang Moka</h1>
            ...
            <div class="item2">
                <h1 class="text-xl lg:text-2xl font-bold text-center mb-10 ">Pertanyaan Tentang Moka Order</h1>
                    {{-- accordion --}}
                    <div id="accordion-collapse" data-accordion="collapse">
    ...
    <div class="Hero section relative min-h-svh w-full flex justify-start pt-24 md:justify-center md:pt-32 ">
        ...
        <div class="mx-0 md:mx-auto w-[75vw] z-20 text-white ps-5 ">
            <h1 class="text-3xl  font-bold  text-left max-w-sm md:max-w-md mb-5">
                Kami ada di sini jika Anda punya masalah menggunakan Moka 
            </h1>
            <p class="text-left text-md text-white break-words max-w-sm mb-16 ">
    ...
    <div class="Hero section relative min-h-svh w-full flex justify-start pt-24 md:justify-center md:pt-32 ">
        ...
        <h1 class="text-3xl  font-bold  text-left max-w-sm md:max-w-md mb-16">
